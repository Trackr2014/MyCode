...
public class GoogleUtil {
    ...
    private static final String USER_AGENT = "Safari/537.36";//"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.113 Safari/537.36";

    private static final Map<String, String> LANGUAGE_MAP = new HashMap();

    private static GoogleUtil _instance = null;
...
//        String finalPath=PATH +"?client="+CLIENT+"&sl="+sourceLang+"&tl="+targetLang+"&dt=t&q="+ text ;
    ...
    public static void main(String[] args) throws Exception {
        ...
        GoogleUtil g = GoogleUtil.getInstance();
        System.out.println(g.translateText("RAID controller card BBU undervoltage. (Cleared)---RAID controller card BBU undervoltage. (Cleared)", "en", "zh_cn"));
    }
